...
//			return "properties/property_item";
		System.out.println("date: " + bookAppointment.getAppointmentDate());
		...
		bookAppointment.setBuyer((User) session.getAttribute("currentUser"));
		System.out.println("name:" + bookAppointment.getAppointmentComment());
