...
<<<<<<< HEAD
											<form:form modelAttribute="bookAppointment" action="addAppointment" method="POST">
										<%-- 		<form:input type="datetime-local" id="appointmentDate" class="form-control" placeholder="Appointment Date Time"
												...
												<form:input type="date" path="appointmentDate" class= "date" name = "dueDate" value = "<fmt:formatDate value="${dueDate}" pattern="MM/dd/yyyy h:mm tt" />"/>
 			 									<form:textarea rows="6" class="form-control" placeholder="What do you want to tell about appointment?"
													path="appointmentComment" required="required"/> 
												<form:hidden path="id" value="${propertyModel.getProperty().getId()}" />
